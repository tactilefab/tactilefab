...
[liblouis 3.38.0 release](https://github.com/liblouis/liblouis/releases/tag/v3.38.0);
replacing `vendor/liblouis/` with your own build is supported and encouraged —
`BUILDING.md` in that directory gives the exact recipe. The JavaScript glue in
`liblouis.js` is generated by [Emscripten](https://emscripten.org/), whose
runtime output is MIT-licensed.
